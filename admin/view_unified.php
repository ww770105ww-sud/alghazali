...
<body>
<?php
// Check unified_accounts table structure
$host = '127.0.0.1';
$user = 'root';
$pass = '738155';
$db   = 'ghazali';
...
try {
    ...
    echo "<h2>هيكل جدول unified_accounts</h2>";
    ...
    echo "<h2>أول 10 صفوف من unified_accounts</h2>";
    $stmt = $pdo->query("SELECT * FROM unified_accounts LIMIT 10");
    if ($stmt->rowCount() > 0) {
