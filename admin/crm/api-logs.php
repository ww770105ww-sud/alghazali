...
try {
    $stmt = $pdo->query("SELECT * FROM crm_api_logs ORDER BY created_at DESC LIMIT 100");
    $logs = $stmt->fetchAll();
...
<div class="apple-container">
    <div class="apple-header">
        <div>
            <h1 class="h3 fw-bold mb-1">سجلات الـ API</h1>
            <p class="text-muted small mb-0">عرض جميع طلبات الـ API</p>
        </div>
                        ...
                        <tbody>
                            <?php foreach ($logs as $log): ?>
                                <tr>
                                    ...
                                    <td><span class="badge bg-primary"><?= h($log['method']) ?></span></td>
